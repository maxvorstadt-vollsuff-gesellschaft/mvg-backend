...
class Drink(Base):
    ...
    consumer_id: Mapped[int] = mapped_column(Integer, ForeignKey("members.id"), nullable=False)
    ...
    posted_by: Mapped[int] = mapped_column(Integer, ForeignKey("members.id"), nullable=True)
